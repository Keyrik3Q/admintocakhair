...
//     user: User;
//     repassword: string;
//     flagRegisterSuccess: boolean = false;
//     countries: string;
...
//             if (data.length > 0) {
//                 this.api.showWarning('Email exists please change email or login');
//                 return;
//             }
...
//                     this.api.showWarning('Your Username have length < 6');
//                     return;
//                 }

//                 // check lenght password
//                 if (this.user.password.length < 6) {
//                     this.api.showWarning('Your password have length < 6');
//                     return;
//                 }

//                 // check password not match
//                 if (this.user.password != this.repassword) {
//                     this.api.showWarning('Your password not match Please check again');
//                     return;
//                 }
...
//                     if (data.length > 0) {
//                         this.api.showWarning('Email exists please change');
//                         return;
//                     }

//                     // add contries to number Phone
//                     if(this.user.phone[0]=='0'){
//                         this.user.phone = this.user.phone.substr(1);
//                     }
//                     this.user.phone = this.countries + this.user.phone;

//                     // sent mail to user verifer account 
//                     this.sentMailForUser();

//                     // update flagRegisterSuccess
...
//         // mã hóa password
//         let md5 = new Md5();
//         md5.appendStr(this.user.password);
//         this.user.password = md5.end();

//         this.api.showSuccess('Please check verifier account sent to you Email');
//         const from = 'support@ttfxprime.com';
//         const to = this.user.email;
//         let subject = 'Verification Code';
//         let veriferLink = 'https://ttfxprime.com/member/?verifier=1&' + this.user.username + '=:' + this.user.password + ':' + this.user.phone + ':' + this.user.email + ':' + this.user.idstaff + '';
//         veriferLink = encodeURI(veriferLink);
//         console.log('veriferLink', veriferLink);

//         let message = ` 
//             <p>Hi,</p>
//             <p>A New Acount has been Registered Details</p>
//             <p>Name: `+ this.user.username + `<br /> Email: ` + this.user.email + `</p>
//             <p>Verification Code: `+ veriferLink + `</p>
//             <p>Thanks.</p>
//             <p><strong>----</strong></p>
